...
2. **Limited available datasets at the barangay level**, the smallest administrative unit in the Philippines, hinders researchers and policymakers to make impactful health interventions, especially for vulnerable communities. 
 ...
 With the support of the [Lacuna Fund](https://lacunafund.org/) and [Wellcome Trust](https://wellcome.org/), the project team aims to ease entry and encourage more studies in the field by frontloading the needed work in assembling an open linked dataset of climate, environmental, socioeconomic, and health variables.
