...
- Access the data in the following links: [GDrive](https://drive.google.com/drive/u/0/folders/1uIaGePIJJCldk3jnKLwnUzrY-nrNzamG),[Kaggle](https://www.kaggle.com/datasets/thinkdatasci/project-cchain/?select=tm_relative_wealth_index.csv),[HDX](https://data.humdata.org/dataset/project-cchain)
- Notebook to link the dataset [here](https://drive.google.com/file/d/1oIRe5GH9290XZluuDFX-USSyBZhqQTN9/view?usp=drive_link) 
- Full documentation [here](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN)
:::

The tables are designed in a way that users can **choose variables that are most relevant** to their focus city and use case, and **link these variables** to form a single dataset by merging using standard geography codes and calendar dates. This can be done using the provided [linking notebook](https://drive.google.com/file/d/1oIRe5GH9290XZluuDFX-USSyBZhqQTN9/view?usp=drive_link), or offline using the user's own code.
