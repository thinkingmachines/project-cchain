...
| Table          | Variables                                                     |
|----------------|---------------------------------------------------------------|
| [calendar](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=calendar)      | date                                                          |
| [location](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=location)      | PSGC admin codes and official English names from level 1 to 4 |
...
| [brgy_geography](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=brgy_geography)  | total area, distance to coast, geometry                       |
...
|------------------------|--------------------------------------------------------------------------------------------|-----------------|------------------|
| [disease_weekly_totals](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=disease_weekly_totals)  | Department of Health - Philippine Integrated Disease Surveillance and Response (DOH-PIDSR) | cases           | city             |
|                        | Philippine Statistical Authority                                                           | deaths          | city             |
|                        | City Local Government Unit Health Offices                                                  | cases, deaths   | baranggay        |
| [disease_monthly_totals](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=disease_monthly_totals) | Department of Health - Field Health Services Information System (DOH-FHSIS)                | cases           | city             |
...
| [informal_settlement_community_surveys_v2](https://dbdocs.io/lacuna-fund-project-team/Project-CCHAIN?table=informal_settlement_community_surveys_v2) | family composition, occupancy type, occupation, power source, water supply, toilet access, finances, education, tenure, transport, hazard experience, disaster support, disease, healthcare access   |
